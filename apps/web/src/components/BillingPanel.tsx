...
/**
 * Subscription / pricing surface. Rendered on /pricing (post-checkout landing)
 * and embedded in the account page. Must be wrapped in <Suspense> by the parent
 * because it reads the `?success=1` query param.
 */
    ...
    return (
      <div className="mx-auto flex w-full max-w-lg flex-col gap-6">
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight">Tu es Pro</h2>
